<template>
    <div>
            ...
            <div class="container-fluid">
                <div class="settings">
                  <a href="javascript:void(0)" @click="$router.go(-1)" >
                    <img style="width: 46px;float: right;" :src="$asseturl+'header.jpeg'" alt="">
        ...
        <section id="btn-area">
            ...
            <div class="row">
                <div class="col-6 p-0 w-50"> <router-link :to="{name:'Recharge'}">Recharge</router-link></div>
                <div class="col-6 p-0 w-50"> <router-link :to="{name:'Withdraw'}">Withdraw</router-link></div>
            </div>
