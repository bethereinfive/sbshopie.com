                                    ...
                                    <div data-v-754c2e37="" class="col-md-6" v-for="(product,index) in products" :key="index" >
                                                <div data-v-754c2e37="" class="product-border">
                                                    ...
                                                    <div data-v-754c2e37="" class="product-details">
                                                        ...
                                                        <p data-v-754c2e37="" style="color: #C89831;">
                                                            {{ product.price }} Tk

                                                        </p>
                                                        <div data-v-754c2e37="" class="text-center"><button data-v-754c2e37="" type="button" style="background:#C89831 !important" class="btn btn-info btn-sm btn-submit" @click="recievefun(product)">Buy Now</button></div>
                                                    </div>
                                                </div>
                                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="shadow">
                    ...
                    <section class="text-center">
                        <button class="btn btn-success" style="background:#C89831 !important" @click="orderSubmit">Order Submit</button>
                        <button class="btn btn-secondary" style="background:red !important" @click="TryAgain">Try Again</button>
                    </section>
                </div>
            </div>
        </section>
