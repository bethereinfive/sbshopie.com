...
<div data-v-464536f2="" class="fifbutton flex_row_between afz14">
    <button type="button" @click="onCancel" data-v-464536f2="" style="border: 0 !important;background: transparent;float: left;padding: 14px 1px;" class="flex1">আদেশ বাতিল</button>
